...
HEIGHT_OFFSET = 270 #262 #round(IMAGE_HEIGHT/2) # Y, to keep in middle of sensor
WIDTH_OFFSET = 0 #196 #round(IMAGE_WIDTH/2) # X, to keep in middle of sensor
...
try:
    ...
    # reading data from Arduino and saving it to csv
...
# so the last AcquisitionActive edges can be discarded by the DAQ system
    ...
    #print(cam1.EventExposureEndFrameID.Value)
