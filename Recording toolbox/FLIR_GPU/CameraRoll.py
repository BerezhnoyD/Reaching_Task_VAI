...
try:
    ...
    for i in range(numImages):
        ...
        d.text((450,5), '{:.2f}'.format(time.time() - tStart)+'    '+str(i), fill=255, font=font)
        #d.line((300,0, 300,408), fill=255, width=2)     # in case we want the lines in the video
        #d.line((1124,0, 1124,408), fill=255, width=2)
